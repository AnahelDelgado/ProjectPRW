...
Route::get('reservarMaterial', 'App\Http\Controllers\EventController@reservaMaterial');
...
Route::get('/reservas/eliminar', 'App\Http\Controllers\EventController@mostrarReservasEliminar')->name('reservas.eliminar');
...
Route::get('/reservas/editar', [EventController::class, 'mostrarReservasEditar'])->name('reservas.editar');

// Ruta para procesar la edición de la reserva
Route::put('/reservas/editar', [EventController::class, 'editarReserva'])->name('reservas.editar');
